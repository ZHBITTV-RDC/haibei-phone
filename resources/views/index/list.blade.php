					...
					<tr class="text-c va-m">
						...
						<td class="td-manage">
							...
							@if($v->content_status==0)
							 ...
							 @endif	
								<i class="Hui-iconfont">&#xe6de;</i></a> <a style="text-decoration:none" class="ml-5" onClick="product_edit('产品编辑','{{URL('admin/editList').'/'.$v -> content_id}}','10001')" href="javascript:;" title="编辑">
							<i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5" onClick="product_del(this,'{{$v -> content_id}}')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
					</tr>
				</tbody>
			        @endforeach
			</table>
	...
	layer.confirm('确认要下架吗？',function(index){       
         $.ajax({
			...
			success:function(data){                
                    $(obj).parents("tr").find(".td-manage").prepend('<a style="text-decoration:none" onClick="product_start(this,{{$v -> content_id}})" href="javascript:;" title="发布"><i class="Hui-iconfont">&#xe603;</i></a>');
